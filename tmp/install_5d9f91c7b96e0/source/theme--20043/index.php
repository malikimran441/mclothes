...
<div class="ttr_images_container">
<?php
if(  $this->countModules('footershape1')):
?>
<div class="ttr_footershape1">
<jdoc:include type="modules" name="footershape1" style="<?php if(($this->params->get('footershape1') == 'block') || ($this->params->get('footershape1') == Null)): echo "xhtml"; endif;?>"/>
</div>
<?php endif; ?>
</div>
...
<?php endif; ?>
<div class=" visible-lg-block d-xl-block d-lg-block visible-md-block d-md-block" style="clear:both;"></div>
<div class=" visible-lg-block d-xl-block d-lg-block visible-md-block d-md-block visible-sm-block d-sm-block visible-xs-block d-block" style="clear:both;"></div>
</div>
</div>
<div style="clear: both;"></div>
