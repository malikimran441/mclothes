...
<div class="ttr_images_container">
<?php
if(  $this->countModules('headershape01')):
?>
<div class="ttr_headershape01">
<jdoc:include type="modules" name="headershape01" style="<?php if(($this->params->get('headershape01') == 'block') || ($this->params->get('headershape01') == Null)): echo "xhtml"; endif;?>"/>
</div>
<?php endif; ?>
...
{
?>
 <?php if($this->params->get('enable_site_logo_link'))
{
?>
<a class="logo" href=<?php echo $linkpath; ?> target="_self">
<?php } ?>
...
<?php endif; ?>
<?php if (($this->params->get('enable_GooglePlus_icon')) || ($this->params->get('enable_GooglePlus_icon') == Null)): ?>
<a target="_self" href="<?php echo $this->params->get('googleplus_Url');?>">
<img <?php if($this->params->get('GooglePlus_icon_Image')!=""):?> src="<?php echo $this->params->get('GooglePlus_icon_Image');?>" <?php else:?> src="<?php echo (JURI::base() . 'templates/' . $app->getTemplate().'/images/footergoogleplus.png')?>" <?php endif; ?> alt="footergoogleplus" class="ttr_footer_googleplus "/>
</a>
<?php endif; ?>
</div>
